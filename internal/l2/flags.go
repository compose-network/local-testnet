...
var (
	stringFlags = []flagDef[string]{
		...
		// Alt-DA
		{"alt-da-da-server", "l2.alt-da.da-server", "", "Alt-DA server endpoint (e.g. http://host.docker.internal:3100)"},
		{"alt-da-put-timeout", "l2.alt-da.put-timeout", "0s", "Timeout for Alt-DA put requests"},
		{"alt-da-get-timeout", "l2.alt-da.get-timeout", "0s", "Timeout for Alt-DA get requests"},
		{"alt-da-da-commitment-type", "l2.alt-da.da-commitment-type", "GenericCommitment", "Alt-DA commitment type (GenericCommitment or KeccakCommitment)"},
	...
	intFlags = []flagDef[int]{
		...
		// Alt-DA
		{"alt-da-max-concurrent-da-requests", "l2.alt-da.max-concurrent-da-requests", 1, "Maximum concurrent Alt-DA requests"},
		{"alt-da-da-challenge-window", "l2.alt-da.da-challenge-window", 100, "Alt-DA challenge window in L1 blocks"},
		{"alt-da-da-resolve-window", "l2.alt-da.da-resolve-window", 100, "Alt-DA resolve window in L1 blocks"},
		{"alt-da-da-bond-size", "l2.alt-da.da-bond-size", 0, "Alt-DA challenge bond size"},
		{"alt-da-da-resolver-refund-percentage", "l2.alt-da.da-resolver-refund-percentage", 0, "Alt-DA resolver refund percentage"},
	...
	boolFlags = []flagDef[bool]{
		...
		{"alt-da-enabled", "l2.alt-da.enabled", false, "Enable Alt-DA mode"},
		{"alt-da-verify-on-read", "l2.alt-da.verify-on-read", true, "Verify Alt-DA data against commitments on read"},
		{"alt-da-da-service", "l2.alt-da.da-service", true, "Use DA service mode where commitments are generated by the Alt-DA server"},
	}
)
